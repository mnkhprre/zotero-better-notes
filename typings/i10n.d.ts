...
export type FluentMessageId =
  ...
  | 'annotationNote-insertion-label'
  ...
  | 'keepLink'
  | 'latex-merge'
  | 'linkCreator-insert-position-end'
  | 'linkCreator-insert-position-label'
  | 'linkCreator-insert-position-start'
  | 'links-embed'
  | 'links-keep'
  | 'links-remove'
  | 'links-standalone'
